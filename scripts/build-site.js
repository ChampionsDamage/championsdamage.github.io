...
<link rel="icon" href="/favicon.ico" sizes="32x32"><link rel="icon" href="/assets/icons/favicon.svg" type="image/svg+xml"><link rel="apple-touch-icon" href="/assets/icons/apple-touch-icon.png">
...
// favicon set (generated by build-favicons.js → src/assets/icons)
...
if (fs.existsSync(ICONDIR)) {
  ...
  writeFile(path.join(DIST, 'assets/icons/favicon.svg'), faviconSVG());
}
